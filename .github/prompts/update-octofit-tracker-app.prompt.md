...
mode: 'agent'
model: GPT-4.1
description: 'Atualizar a app Django OctoFit Tracker para suportar as coleções e endpoints principais.'
---
...
3. Certifique-se de que `/` aponta para a API e que `api_root` está presente em `urls.py`.
